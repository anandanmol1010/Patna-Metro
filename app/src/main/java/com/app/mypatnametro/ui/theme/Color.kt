...
val BlueLineColor = Color(0xFF1EACFA) // Blue metro line

// Gradient Colors for Metro Card
val GradientStart = Color(0xFFFF0000) // Red
val GradientOrange = Color(0xFFFFA500) // Orange  
val GradientYellow = Color(0xFFFFFF00) // Yellow
val GradientEnd = Color(0xFF1EACFA) // Blue
